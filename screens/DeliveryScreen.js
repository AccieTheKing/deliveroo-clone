...
import { Platform, SafeAreaView, Text, View, TouchableOpacity, Image } from 'react-native';
...
const DeliveryScreen = () => {
  ...
  return (
    <View className="bg-[#00CCBB] flex-1">
      <SafeAreaView className={`${Platform.OS === 'ios' ? '' : 'pt-[35px]'} z-50`}>
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-28">
        ...
        <View className="flex-1">
          <Text className="text-lg">Acdaling Edusei</Text>
